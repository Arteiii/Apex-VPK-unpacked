...
void function AnimateXPBar( bool isFirstTime )
{
	...
	int persistenceScore				  = GetRankedPersistenceData( player, "currentRankedScore" )
	...
	if ( score == previousScore && score != persistenceScore )
	{
		#if DEV
			printt( "RANKED DEBUG: CommunityUserInfo is stale. Defer to persistence data." )
		#endif
