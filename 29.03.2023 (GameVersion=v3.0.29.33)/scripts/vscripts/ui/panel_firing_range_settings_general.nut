...
void function SetupSettings()
{
	...
	SetupSettingsButton( file.generalSettingsToHud[ eFRSettingType.FRDUMMIESHIELDLVL ], "#FRSETTING_DUMMIESHIELD", "ERROR", $"", false, true )
...
void function UpdateDetails()
{
	...
	{
		Hud_SetDialogListSelectionValue( file.generalSettingsToHud[ eFRSettingType.FRIENDLYFIRE ], string( file.friendlyFireOn ))
	}
	...
	Hud_SetEnabled( file.dummieBehaviorSettingsToHud[ eDummieBehaviorType.STAYINPLACE ], file.isRangeMaster && canStrafe && !fcOn )
	Hud_SetEnabled( file.dummieBehaviorSettingsToHud[ eDummieBehaviorType.STRAFE ], file.isRangeMaster && !fcOn )
	Hud_SetEnabled( file.generalSettingsToHud[ eFRSettingType.FRDUMMIESPEED ], file.isRangeMaster && canStrafe && !fcOn )
	...
	Hud_SetEnabled( file.dummieBehaviorSettingsToHud[ eDummieBehaviorType.CANSTAND ], file.isRangeMaster && canCouch && !fcOn )
	Hud_SetEnabled( file.dummieBehaviorSettingsToHud[ eDummieBehaviorType.CANCROUCH ], file.isRangeMaster && !fcOn )
	Hud_SetEnabled( file.dummieBehaviorSettingsToHud[ eDummieBehaviorType.RANDINTERVALS ], file.isRangeMaster && !fcOn )
...
void function Firing_Range_DummieSettingChanged( int setting, var btn )
{
	...
	switch( setting )
	{
		case eDummieBehaviorType.STAYINPLACE:
			...
			Remote_ServerCallFunction( "UCB_SV_FRDummie_Bool", eDummieBehaviorType.STAYINPLACE, boolValue, true )
			break
		case eDummieBehaviorType.STRAFE:
			file.dummieBehaviorSettings[ setting ] <- float( boolValue )
			Remote_ServerCallFunction( "UCB_SV_FRDummie_Bool", eDummieBehaviorType.STRAFE, boolValue, true )
			break
		case eDummieBehaviorType.CANSTAND:
			file.dummieBehaviorSettings[ setting ] <- float( boolValue )
			Remote_ServerCallFunction( "UCB_SV_FRDummie_Bool", eDummieBehaviorType.CANSTAND, boolValue, true )
			break
		case eDummieBehaviorType.CANCROUCH:
			file.dummieBehaviorSettings[ setting ] <- float( boolValue )
			Remote_ServerCallFunction( "UCB_SV_FRDummie_Bool", eDummieBehaviorType.CANCROUCH, boolValue, true )
			break
		case eDummieBehaviorType.RANDINTERVALS:
			file.dummieBehaviorSettings[ setting ] <- float( boolValue )
			Remote_ServerCallFunction( "UCB_SV_FRDummie_Bool", eDummieBehaviorType.RANDINTERVALS, boolValue, true )
			break
