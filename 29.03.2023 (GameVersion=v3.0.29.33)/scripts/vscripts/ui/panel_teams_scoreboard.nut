...
{
	file.panels[file.activePanel].isSpectator = isSpectator
...
bool function PlayerButton_OnKeyPress( var button, int keyId, bool isDown )
{
	...
	bool isCustomMatchSpectator = CustomMatch_IsInCustomMatch() && HasMatchAdminRole() && file.panels[file.activePanel].isSpectator
