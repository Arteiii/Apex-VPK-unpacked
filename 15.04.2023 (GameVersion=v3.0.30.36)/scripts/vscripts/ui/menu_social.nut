...
{
	ConfirmDialogData data
	data.headerText = Localize ("#JOIN_FIRING_RANGE_AS_PARTY_MEMBER", friendName )
	data.messageText = Localize ( "#JOIN_FIRING_RANGE_AS_PARTY_MEMBER_DESC", friendName )
...
void function FriendButton_OnJoin( var panel, var button, int index )
{
	...
	if ( CurrentlyInParty() )
	{
		...
		{
			if (friend.presence == Localize("#PL_FIRINGRANGE"))
			{
...
void function InspectFriend( Friend friend, bool attemptRTKMenu )
{
	...
	{
		RTKStatsScreen_UpdateCurrentBRUnrankedSeasonDataModel()                                                                                                                                                                                                              
