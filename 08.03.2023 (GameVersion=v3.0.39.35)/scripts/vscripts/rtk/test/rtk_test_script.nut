...
void function RTKTestScript_InitMetaData( string behaviorType, string structType )
{
	...
	RTKMetaData_SetPropertyDescription( structType, "onFoo", "this is a decription for onFoo (added for testing purposes)" )
	RTKMetaData_SetPropertyDescription( structType, "val", "this is a decription for val (added for testing purposes)" )
	RTKMetaData_SetPropertyDescription( structType, "factor", "this is a decription for factor (added for testing purposes)" )
	RTKMetaData_SetPropertyDescription( structType, "threshold", "this is a decription for threshold (added for testing purposes)" )
	RTKMetaData_SetPropertyDescription( structType, "testString", "this is a decription for testString (added for testing purposes)" )
	RTKMetaData_SetPropertyDescription( structType, "testBehavior", "this is a decription for testBehavior (added for testing purposes)" )
	RTKMetaData_SetPropertyDescription( structType, "onCrossThreshold", "this is a decription for onCrossThreshold (added for testing purposes)" )
}
