...
void function ClientCodeCallback_MapInit()
{
	...
	SURVIVAL_AddMinimapLevelLabel( "#DES_ZONE_6_MONUMENT", 0.52, 0.40, 0.5 )                                      
	SURVIVAL_AddMinimapLevelLabel( "#DES_ZONE_6_FRAGMENT", 0.66, 0.44, 0.5 )                                           
	...
	SURVIVAL_AddMinimapLevelLabel( "#DES_ZONE_15_STACKS", 0.80, 0.80, 0.5 )                                  
