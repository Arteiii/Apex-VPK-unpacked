...
void function updateDeadzoneButtons()
{
	...
	{
		Hud_SetVisible( file.swchTriggerDeadzoneBtn, false )
		Hud_SetVisible( file.SwchTriggerDeadzoneADTBtn, true )
		Hud_SetNavDown( file.adaptiveTriggersBtn, file.SwchTriggerDeadzoneADTBtn )
		Hud_SetNavUp( file.sldCursorVelocityBtn, file.SwchTriggerDeadzoneADTBtn )
	}
	else
	{
		Hud_SetVisible( file.swchTriggerDeadzoneBtn, true )
		Hud_SetVisible( file.SwchTriggerDeadzoneADTBtn, false )
...
#if PS5_PROG
	file.SwchTriggerDeadzoneADTBtn = SetupSettingsButton( Hud_GetChild( contentPanel, "SwchTriggerDeadzoneADT" ), "#GAMEPAD_TRIGGER_DEADZONES", "#GAMEPAD_TRIGGER_DEADZONES_DESC", $"rui/menu/settings/settings_gamepad" )
#endif
#endif
...
void function OnControlsGamepadPanel_Show( var panel )
{
	...
	{
		Hud_Show( vibBtn )
		Hud_Show( file.swchTriggerDeadzoneBtn )
		Hud_Hide( vibBtnPs5 )
		Hud_Hide( file.adaptiveTriggersBtn )
		Hud_Hide( file.SwchTriggerDeadzoneADTBtn )
