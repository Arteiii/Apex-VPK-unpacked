...
void function SetupNarrativeDebugDevMenu()
{
	...
	SetupDevMenu ( "S17 Tropics Storm Event", SetDevMenu_S17StormDebug )
...
void function SetDevMenu_S17StormDebug( var _ )
{
	ChangeToThisMenu( SetupS17StormDebug )
}

void function SetupS17StormDebug()
{
	SetupDevCommand("Phase 0 (Disabled)", "launchplaylist survival_s17st_disabled")
	SetupDevCommand("Phase 1", "launchplaylist survival_s17st_phase1")
	SetupDevCommand("Phase 2", "launchplaylist survival_s17st_phase2")
	SetupDevCommand("Phase 3", "launchplaylist survival_s17st_phase3")
}
